...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int value = job.getJobState().getValue();
        System.out.println("stateId:" + value);

        float mapProgress = job.getStatus().getMapProgress();
        System.out.println("mapProgress:" + mapProgress);
