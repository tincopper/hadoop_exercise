 ...
 **/
public class GearbestCdnDataToOrc {
    private static Logger LOG = LoggerFactory.getLogger(GearbestCdnDataToOrc.class);
    ...
    public static class OrcWriterMapper extends Mapper<LongWritable, Text, NullWritable, OrcStruct> {
        ...
        public void map(LongWritable key, Text value, Context output) throws IOException, InterruptedException {
            ...
            if (!"".equals(value.toString())) {
                ...
                multipleOutputs.write(nada, pair, "cdn-sl-dresslily-formated");
            }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        conf.setClass(Job.MAP_OUTPUT_COMPRESS_CODEC, GzipCodec.class, GzipCodec.class);
        ...
        job.setJarByClass(GearbestCdnDataToOrc.class);
